...
// Video Player
// =============================================================================
if ( !function_exists('tco_shortcode_video_player') ) {
  function tco_shortcode_video_player( $atts ) {
    ...
    $data              = cs_generate_data_attributes( 'tco_mejs', array( 'poster' => $poster ) );
  ...
  add_shortcode( 'tco_video_player', 'tco_shortcode_video_player' );
  if (! shortcode_exists('x_video_player')) {
