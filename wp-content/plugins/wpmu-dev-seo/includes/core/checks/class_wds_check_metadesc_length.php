...
class Smartcrawl_Check_Metadesc_Length extends Smartcrawl_Check_Post_Abstract {
	...
	public function get_status_msg() {
		if ( ! is_numeric( $this->_state ) ) { return __( 'Description is a good length', 'wds' ); }
	...
	public function get_max() {
		if ( defined( 'SMARTCRAWL_METADESC_LENGTH_CHAR_COUNT_LIMIT' ) && SMARTCRAWL_METADESC_LENGTH_CHAR_COUNT_LIMIT ) { return SMARTCRAWL_METADESC_LENGTH_CHAR_COUNT_LIMIT; }
		return 160;
	}
}