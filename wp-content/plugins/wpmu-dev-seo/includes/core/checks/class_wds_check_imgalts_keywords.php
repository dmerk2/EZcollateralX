...
class Smartcrawl_Check_Imgalts_Keywords extends Smartcrawl_Check_Post_Abstract {
	...
	public function get_more_info() {
		return __( "Image alternative text attributes help search engines correctly index images, aid visually impaired readers and the text is used in place of the image if it's unable to load. You should add alternative text for all images in your content.", 'wds' );
	}
}