          ...
          <tr>
            <th>
              <label for="tco_google_analytics_code">
                <strong><?php _e( 'Analytics Code', '__tco__' ); ?></strong>
                <span><?php _e( 'Input your Google Analytics code exactly as it is provided (i.e. with the &lt;script&gt; tags included).', '__tco__' ); ?></span>
              </label>
            </th>
            <td><textarea name="tco_google_analytics_code" id="tco_google_analytics_code" class="code"><?php echo ( isset( $tco_google_analytics_code ) ) ? esc_textarea( $tco_google_analytics_code ) : ''; ?></textarea>
            </td>
          </tr>
