...
<p>
  <?php _e( 'The latitude and longitude of your organization for online maps. Google can get info from the address, but your organization won\'t be shown on maps unless you also fill in these co-ordinates.', '__tco__' ); ?>
</p>
  ...
  <tr>
    <th>
      <label for="<?php echo $plugin_slug . '_geo_latitude'; ?>">
        <strong><?php _e( 'Latitude', '__tco__' ); ?></strong>
        <span><?php _e( 'Inline help.', '__tco__' ); ?></span>
      </label>
    </th>
    <td>
  ...
  <tr>
    <th>
      <label for="<?php echo $plugin_slug . '_geo_longitude'; ?>">
        <strong><?php _e( 'Longitude', '__tco__' ); ?></strong>
        <span><?php _e( 'Inline help.', '__tco__' ); ?></span>
      </label>
    </th>
    <td>
