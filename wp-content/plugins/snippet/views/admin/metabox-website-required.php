...
<p>
  <?php _e( 'This below field is required to properly generate the Schema information for your website. ', '__tco__' ); ?>
</p>
  ...
  <tr>
    <th>
      <label for="<?php echo $plugin_slug . '_website_url'; ?>">
        ...
        <span><?php _e( 'URL address of your website - default to "WordPress Address (URL)" on Settings -> General Settings.', '__tco__' ); ?></span>
      </label>
    </th>
    <td>
